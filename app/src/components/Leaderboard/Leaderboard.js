  ...
  return (
    <div className='leaderboard' onClick={e=>e.stopPropagation()}>
        ...
        <div className='leaderboard-first'>
            ...
            <div className='first-image' onClick={()=>dispatch(playerUpdate(playersData[0]))}><img alt='' src={playersData[0]?.image}/></div>
        ...
        <div className='leaderboard-list'>
            {playersData.map((player, idx)=>{
                if(!idx) return
                return(
                    <div className='leaderboard-player' key={idx} onClick={()=>dispatch(playerUpdate(player))}>
